    ...
    <ClerkProvider 
      ...
      appearance={{
        ...
        elements: {
          ...
          socialButtonsBlockButton: "bg-canvas-100/50 border border-white/[0.04] !shadow-none hover:bg-canvas-200/50 text-white !rounded-xl py-3 transition-colors",
          ...
          formFieldInput: "bg-canvas-200/50 border border-white/5 !shadow-none !outline-none text-ink-primary !rounded-xl px-4 py-3 focus:border-brand-500/50 focus:ring-1 focus:ring-brand-500/50 transition-all text-sm",
          formButtonPrimary: "bg-brand-500 hover:bg-brand-600 text-white font-semibold text-sm py-3 !rounded-xl !border-none !shadow-none hover:!shadow-ag-glow-primary transition-all active:scale-[0.98]",
